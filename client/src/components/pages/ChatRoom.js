...
function ChatRoom({ user }) {
  ...
  // SB: 채팅방을 나가면 socket의 room도 나가게 하는 함수입니다.  뒤로가기( < ) 버튼에 걸려있습니다.
  const exitRoom = () => {
  ...
  // SB: 구매 관련 버튼을 누르면 구매 현황 정보를 DB에 저장하고 socket으로 전송하는 함수입니다.
  ...
  // SB: socket으로 받은 파일 url을 useState로 저장하는 함수입니다.
